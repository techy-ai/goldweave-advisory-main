          ...
          {links.map((l) => {
            ...
            return (
              ...
              >
                <Link
                  href={l.to}
                  className={`relative px-4 py-2 text-[15px] ${isActive(l.to) ? "text-[var(--gold)]" : "text-white/80"} hover:text-[var(--gold-soft)] transition-colors group inline-flex items-center gap-1`}
                >
                  {l.label}
