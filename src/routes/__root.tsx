  ...
  head: () => ({
    meta: [
      ...
      { title: "Dhiren S Patel — Tax Consultant & Finance Advisor, Ahmedabad" },
      {
        name: "description",
        content:
          "Trusted Ahmedabad-based tax consultant & finance advisor. GST, Income Tax, Mutual Funds, Insurance, Business Advisory for individuals, SMEs and startups.",
      },
      { name: "author", content: "Dhiren S Patel" },
      { property: "og:site_name", content: "Dhiren S Patel" },
