...
export const Route = createFileRoute("/about")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "About — Dhiren S Patel" },
      { property: "og:description", content: "Trusted advisor for 1,200+ clients across Gujarat." },
      ...
      <section className="py-24 lg:py-32 px-6 lg:px-10">
        <div className="mx-auto max-w-7xl grid lg:grid-cols-12 gap-12 items-center">
          ...
          <Reveal delay={0.1} className="lg:col-span-7">
            ...
            <div>
              <div className="font-semibold text-lg">Dhiren S Patel</div>
